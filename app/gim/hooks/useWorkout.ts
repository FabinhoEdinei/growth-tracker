...
export function useWorkout(workout: Workout) {
  ...
  function advance(prev: WorkoutState, progress: Record<string, ExerciseProgress>): WorkoutState {
  ...
  function advanceExercise(prev: WorkoutState, progress: Record<string, ExerciseProgress>): WorkoutState {
    const block = workout.blocks[prev.currentBlockIndex];
