...
// ─── Treino Full Body 45min — Halteres + Corpo Livre ─────────────────────────
// Estrutura: Aquecimento → Bloco A (Peito/Tríceps) → Bloco B (Costas/Bíceps)
//            → Bloco C (Pernas/Glúteos) → Bloco D (Core/Ombros) → Finalizador
...
export const WORKOUT_FULLBODY_45: Workout = {
  ...
  blocks: [
    // ── AQUECIMENTO (5min) ────────────────────────────────────────────────
    {
      id: 'warmup',
      name: 'AQUECIMENTO',
      description: '5 minutos para ativar articulações e elevar a frequência cardíaca',
      exercises: [
        {
          id: 'jumping-jacks',
          name: 'Jumping Jacks',
          ...
          cues: [
            ...
            'Aterrisse suavemente nos calcanhares',
        ...
        },
        {
          ...
          cues: [
            'Mãos na cintura',
            'Círculos amplos e lentos',
            'Solte a tensão lombar',
          ],
        },
        {
          id: 'squat-warmup',
          ...
          cues: [
            ...
            'Joelhos acompanham os dedos',
            'Desça até 90° ou além',
          ],
        },
      ],
    },
      ...
      exercises: [
        {
          ...
          cues: [
            ...
            'Toque os halteres no topo sem travar cotovelo',
          ],
        },
        {
          id: 'push-up',
          ...
          emoji: '⬇️',
          cues: [
            'Corpo rígido do calcanhar à cabeça',
            'Mãos ligeiramente mais largas que ombros',
            'Peito toca o chão — amplitude total',
            'Expire na subida',
          ],
        },
        {
          ...
          cues: [
            ...
            'Cotovelo fixo — só o antebraço se move',
            'Estenda completamente no topo',
            'Faça 1s de pausa na extensão',
          ],
        },
      ],
    },
      ...
      exercises: [
        {
          ...
          emoji: '🚣',
          cues: [
            'Quadril dobrado a 45°, coluna neutra',
            'Puxe os cotovelos para trás e para cima',
            'Escápulas se aproximam no topo',
            'Desça controlado — não deixe cair',
          ],
        },
        {
          id: 'renegade-row',
          ...
          emoji: '🤸',
          cues: [
            'Posição de prancha sobre os halteres',
            'Core ultra-contraído — não gire o quadril',
        ...
        },
        {
          ...
          cues: [
            ...
            'Supine o punho ao subir',
            'Desça sem jogar — 2-3 segundos',
            'Amplitude completa: extensão total embaixo',
          ],
        },
      ],
    },
      ...
      exercises: [
        {
          ...
          emoji: '🏆',
          cues: [
            'Halter segurado na vertical contra o peito',
            'Cotovelos empurram os joelhos para fora',
            'Desça abaixo dos 90° se possível',
            'Suba expirando — empurre o chão',
          ],
        },
        {
          ...
          emoji: '⚙️',
          cues: [
            'Joelhos levemente dobrados — NÃO é agachamento',
            'Halteres raspam as pernas o tempo todo',
            'Sinta o alongamento dos isquiotibiais',
            'Quadril vai para trás — não a barriga para baixo',
          ],
        },
        {
          id: 'reverse-lunge',
          ...
          cues: [
            ...
            'Joelho da frente não passa a ponta do pé',
      ...
      exercises: [
        {
          ...
          cues: [
            ...
            'Empurre acima da cabeça sem trancar',
        ...
        },
        {
          ...
          cues: [
            ...
            'Quadril na linha do corpo — nem alto nem baixo',
            'Aperte o glúteo e o core simultaneamente',
        ...
        },
        {
          ...
          emoji: '🌪️',
          cues: [
            'Pés levantados ou no chão para facilitar',
            'Gire o tronco — não só os braços',
            'Toque o halter lateralmente no chão',
    ...
    // ── FINALIZADOR (2min) ────────────────────────────────────────────────
    {
      ...
      exercises: [
        ...
        },
        {
          ...
          name: 'Alongamento do Flexor do Quadril',
          equipment: 'bodyweight',
          muscleGroup: 'glutes',
          sets: 1,
          reps: '30s cada',
...
// ── Helper: total de exercícios e séries ─────────────────────────────────────

export function getTotalSets(workout: Workout): number {
  return workout.blocks.flatMap(b => b.exercises).reduce((sum, ex) => sum + ex.sets, 0);
}
